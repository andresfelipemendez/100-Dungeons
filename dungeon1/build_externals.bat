...
clang++ -shared -std=c++17 -g -D_ITERATOR_DEBUG_LEVEL=0 ^
    -I"%INCLUDE_PATH%" -I"%EXTERNALS_SRC_PATH%" -I"%CORE_INCLUDE_PATH%" -I"%GLAD_INCLUDE_DIR%" ^
    ...
    -lglad -lglfw3dll -limgui -lucrt -lmsvcrt^
