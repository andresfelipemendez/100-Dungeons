...
set "EDITOR_INCLUDE_PATH=%PROJECT_ROOT%\src\editor"
set "EDITOR_SRC_PATH=%PROJECT_ROOT%\src\editor"
set "GENERATOR_INCLUDE_PATH=%PROJECT_ROOT%\src\generator"
set "GENERATOR_SRC_PATH=%PROJECT_ROOT%\src\generator"
